							...
							if(isset($preguntas)){
								...
								foreach ($preguntas as $pregunta) {
									...
									echo '<div class="col-xs-12 col-md-6 col-lg-4 table-row">';
										...
										echo '</div>';
										echo '<div class="col-xs-9">';
											echo Html::anchor('curso/examen/mostrar_pregunta/'.$pregunta->id_pregunta.'?date='.time(),'<div  class="overflow itemPregunta"><b>Nivel '.$pregunta->dificultad.':</b> <i><span>'.$pregunta->texto.'</span></i></div>', array('class' => ''));
											echo "<br>";
										echo '</div>';
										echo "</br>";
									echo '</div>';
